                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-gray-300 mb-4 max-w-md">
                            Chúng tôi chuyên thiết kế và thi công các công trình kiến trúc với phong cách hiện đại,
                            mang lại không gian sống hoàn hảo và bình yên cho mọi gia đình.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="/portfolio" className="text-gray-300 hover:text-white transition-colors">Dự án</a></li>
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <span className="text-gray-300">info@kientrucanlac.com</span>
                            </div>
                        </div>
                    </div>
                </div>
